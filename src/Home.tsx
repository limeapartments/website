...
export default () => (
  <>
    ...
    />
    <SectionImageDiv
      image={require('../static/images/home-background-section0.jpg')}
    >
      <VFlex>
        <TitleDiv>LUXURY SCHMUXURY</TitleDiv>
        <SubtitleDiv>
    ...
    <BlackStriped>
      <VFlex>
        <TitleDiv>LIME APARTMENTS</TitleDiv>
        <SubtitleDiv>A LITTLE TART. A LITTLE TANGY. NEVER BORING.</SubtitleDiv>
        <ImageGrid
          data={[
            {
    ...
    <SectionImageDiv
      image={require('../static/images/home-background-section1.jpg')}
    >
      <VFlex>
        <TitleDiv>GET SOCIAL</TitleDiv>
        <SubtitleDiv>CONNECT WITH LIME ON FACEBOOK</SubtitleDiv>
        <div
          style={{
            maxWidth: 500,
          }}
        ...
        >
          <blockquote
            cite="https://www.facebook.com/Lime-Apartments-389529864487875/"
    ...
    <BlackStriped>
      <VFlex>
        <TitleDiv>WANNA CHAT?</TitleDiv>
        <SubtitleDiv>DROP BY AND SAY HI...</SubtitleDiv>
        <div
          style={{
            width: '100%',
            display: 'flex',
    ...
    <SectionImageDiv
      image={require('../static/images/home-background-section2.jpg')}
    >
      <div style={{ width: '80%' }}>
        <VFlex>
          <TitleDiv>UPTOWN</TitleDiv>
          <SubtitleDiv>THE LYN-LAKE LYFESTYLE</SubtitleDiv>
    ...
    <SectionImageDiv
      image={require('../static/images/home-background-section3.jpg')}
    >
      <VFlex>
        <TitleDiv>THE VIEW FROM THE LIME TERRACE</TitleDiv>
        <SubtitleDiv>DOWNTOWN MINNEAPOLIS</SubtitleDiv>
      </VFlex>
    </SectionImageDiv>
    <BlackStriped>
      <VFlex>
        <TitleDiv>PUCKER UP</TitleDiv>
        <div
          style={{
            margin: 20,
            textAlign: 'center',
        ...
        >
          <p>
            Looking for an apartment community offering valuable{' '}
            <GreenLink to="/amenities">amenities</GreenLink>?{' '}
            <strong>
              <em>Check.</em>
            </strong>
          </p>
          <p>
            In a prime Minneapolis{' '}
            <GreenLink to="/location">location</GreenLink>?{' '}
            <strong>
              <em>Check.</em>
            </strong>
          </p>
          <p>
            With open <GreenLink to="/floor-plans">floor plans</GreenLink> that
            maximize space, pay attention to detail and provide natural
            lighting?{' '}
            <strong>
              <em>Check.</em>
            </strong>
          ...
          <p>
            Filled with fun-loving{' '}
            <GreenLink to="/residents">residents</GreenLink> you&#39;d like to
            meet?{' '}
            <strong>
              <em>Check.</em>
            </strong>
          ...
          <p>
            Scope out our <GreenLink to="/gallery">gallery</GreenLink> for some
            more eye-candy, then <GreenLink to="/contact">contact us</GreenLink>{' '}
            to find out more.
          </p>
        </div>
