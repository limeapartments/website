...
export default () => (
  <>
    ...
    />
    <SectionImageDiv
      image={require('../static/images/location-blue-background.jpg')}
      overlayOpacity={0}
    >
      <VFlex>
        <TitleDiv>Uptown, lyn lake, midtown and beyond</TitleDiv>
        <div
          style={{
        ...
        <ContentP>
          The Lime community thrives both inside and out. Situated in Lyn Lake
          proper, our excellent walk, transit and bike scores mean you’ll live
          right in the thick of it, with immediate access to just about anything
          you need.
        </ContentP>
        <ContentP>
          Looking to explore? Take a walk or hop on Metro Transit. To your west
          awaits Uptown nightlife, the beaches and waterways of Lake Calhoun,
          Harriet and Isles. To your north, lies the Downtown business district
          and to your east, Midtown Global Market.
        </ContentP>
        <ContentP>
          With Nice Ride bike rentals, numerous bike shops and miles of paved
          trails right outside your door, there’s little reason to use a car.
          Ease traffic and stay healthy at Lime.
        </ContentP>
      </VFlex>
    </SectionImageDiv>
    <BlackStriped>
      <VFlex>
        <TitleDiv>Sample the neighborhood</TitleDiv>
        <ImageGrid
          style={{ padding: 20 }}
          data={[
            {
        ...
        />
        <WhiteButton to="/contact">I want to live here!</WhiteButton>
      </VFlex>
    </BlackStriped>
    <Footer />
    <CallNow />
